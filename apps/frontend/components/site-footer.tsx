...
const footerLinks = {
  ...
  "Doing Business": [
    { label: "Become a Stepper", href: "/stepper" },
    { label: "Be a Partner Restaurant", href: "/partner" },
    { label: "Get DoorStep for Business", href: "/business" },
    { label: "Get DoorStep for Work", href: "/work" },
  ],
}
    ...
    <footer className="bg-foreground text-white py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-white/50">© 2025 DoorStep</p>
        </div>
      </div>
    </footer>
  )
